...
CLASS lhc_travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_travel_m_pin.
...
********************************************************************************
  METHOD get_features.
    ...
    READ ENTITY zi_travel_m_pin FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
  ...
  METHOD validate_agency.
    ...
    READ ENTITY zi_travel_m_pin\\travel FROM VALUE #(
...
********************************************************************************
  METHOD set_status_completed.
    ...
    MODIFY ENTITIES OF zi_travel_m_pin IN LOCAL MODE
           ENTITY travel
    ...
    READ ENTITIES OF zi_travel_m_pin IN LOCAL MODE
         ENTITY travel
  ...
  METHOD calculatetravelkey.
    ...
    "Get max travelID
    SELECT SINGLE FROM ztravel_pin FIELDS MAX( travel_id ) INTO @DATA(lv_max_travelid).
