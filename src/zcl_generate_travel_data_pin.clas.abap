CLASS zcl_generate_travel_data_pin DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_pin IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_pin.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_pin.

*   insert the new table entries
    INSERT ztravel_pin FROM TABLE @itab.
